...
$resultTransaksi = mysqli_query($con,  "SELECT * FROM transaksi INNER JOIN users ON transaksi.id_user = users.id WHERE id_user = $id ORDER BY created_at DESC");
      ...
      <div class="mt-5" style="height:70vh">
        <div class="container">
          ...
          <ul class="nav nav-tabs mb-3">
            <li class="nav-item">
              <a class="nav-link active" href="index.php" aria-current="page">Semua</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="proses.php">Proses</a>
            </li>
            <li class="nav-item">
