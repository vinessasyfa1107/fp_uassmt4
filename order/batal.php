...
$resultTransaksi = mysqli_query($con,  "SELECT * FROM transaksi INNER JOIN users ON transaksi.id_user = users.id WHERE id_user = $id AND transaksi.status = 'batal' ORDER BY created_at DESC");
      ...
      <div class="mt-5" style="height:70vh">
        <div class="container">
          ...
          <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="batal.php">Dibatalkan</a>
            </li>
          </ul>
